package com.steven.testSpring.test1.dependencyJar.util;
...
public class WebRequestUtil {
     ...
     * @throws IOException
     */
    public static String getJson(String m_Url, Map<String, String> p_Params) throws IOException {
     ...
     * @throws IOException
     */
    public static String getHtml(String m_Url, Map<String, String> p_Params) throws IOException {
        m_Url = setParams(m_Url, p_Params);
        URL m_UrlUtil = new URL(m_Url);
        c_HttpURLConnection = (HttpURLConnection) m_UrlUtil.openConnection();
        setConnectionProperty();
